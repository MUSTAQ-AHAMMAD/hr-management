                    ...
                    <form action="{{ route('departments.update', $department) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="type" name="type" type="text" class="mt-1 block w-full" :value="old('type', $department->type)" required placeholder="e.g., IT, Admin, Finance, HR, Operations" />
