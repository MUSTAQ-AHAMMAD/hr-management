                    ...
                    <div class="border border-gray-200 rounded-lg p-4 mb-4">
                        ...
                        <form action="{{ route('task-assignments.update-status', $assignment) }}" method="POST" class="mt-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    <select name="status" class="block w-full border-gray-300 focus:border-navy-500 focus:ring-navy-500 rounded-md shadow-sm text-sm">
                                ...
                                <div>
                                    <input type="text" name="notes" placeholder="Add notes (optional)" class="block w-full border-gray-300 focus:border-navy-500 focus:ring-navy-500 rounded-md shadow-sm text-sm" value="{{ $assignment->notes }}">
                                </div>
                                <div>
