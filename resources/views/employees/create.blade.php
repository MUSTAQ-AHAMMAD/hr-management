                    ...
                    <form action="{{ route('employees.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="employee_code" name="employee_code" type="text" class="mt-1 block w-full" :value="old('employee_code')" required autofocus />
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500">Leave blank if email needs to be created by IT team</p>
