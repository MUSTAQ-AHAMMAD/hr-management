<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Summary Card -->
            <div class="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-purple-500 mb-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-5">
                        <p class="text-sm font-semibold text-gray-600">Total Onboarding Tasks</p>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                ...
                                <tr class="hover:bg-gradient-to-r hover:from-purple-50 hover:to-indigo-50 transition-all duration-200">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-10 w-10 flex items-center justify-center rounded-full bg-gradient-to-br from-purple-100 to-purple-200 shadow-sm">
                                ...
                                <tr id="task-{{ $assignment->id }}" class="hidden bg-purple-50">
