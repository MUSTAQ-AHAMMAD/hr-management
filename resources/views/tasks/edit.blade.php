                    ...
                    <form action="{{ route('tasks.update', $task) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <x-text-input id="name" name="name" type="text" class="mt-1 block w-full pl-10" :value="old('name', $task->name)" required autofocus placeholder="Enter task name" />
                                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <x-text-input id="priority" name="priority" type="number" min="1" class="mt-1 block w-full pl-10" :value="old('priority', $task->priority)" required />
                                </div>
                        ...
                        <div class="mt-6">
                            ...
                            <div class="relative">
                                ...
                                <textarea id="description" name="description" rows="4" placeholder="Provide detailed instructions for completing this task..." class="mt-1 block w-full pl-10 border-gray-300 focus:border-cobalt-500 focus:ring-cobalt-500 rounded-md shadow-sm">{{ old('description', $task->description) }}</textarea>
                            </div>
                        ...
                        <div class="mt-6">
                            <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                                <label class="flex items-center cursor-pointer group">
                                    <input type="checkbox" name="is_active" value="1" class="rounded border-gray-300 text-cobalt-600 shadow-sm focus:ring-cobalt-500" @checked(old('is_active', $task->is_active))>
