<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <!-- Total Assets -->
                <div class="group relative bg-gradient-to-br from-cyan-50 to-sky-50 overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                    <div class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-cyan-400/20 to-sky-600/20 rounded-full -mr-16 -mt-16 group-hover:scale-150 transition-transform duration-500"></div>
                    <div class="relative p-6">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex-shrink-0 w-14 h-14 bg-gradient-to-br from-cyan-500 to-sky-600 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                                <svg class="h-7 w-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z" />
                                </svg>
                            </div>
                            <a href="{{ route('assets.index') }}" class="text-xs font-semibold text-cyan-600 bg-cyan-100 px-3 py-1 rounded-full hover:bg-cyan-200 transition">View</a>
                        </div>
                        <h3 class="text-sm font-medium text-gray-600 mb-1">Total Assets</h3>
                        <p class="text-3xl font-bold text-gray-900">{{ $assetStats['total_assets'] }}</p>
                        <p class="text-xs text-gray-500 mt-1">Value: ${{ number_format($assetStats['total_asset_value'], 2) }}</p>
                    </div>
                </div>
                ...
                <div class="group relative bg-gradient-to-br from-blue-50 to-indigo-50 overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    <div class="relative p-6">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex-shrink-0 w-14 h-14 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                                <svg class="h-7 w-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <h3 class="text-sm font-medium text-gray-600 mb-1">Assigned Assets</h3>
                        <p class="text-3xl font-bold text-gray-900">{{ $assetStats['assigned_assets'] }}</p>
                    </div>
                </div>

                <!-- Damaged Assets -->
                <div class="group relative bg-gradient-to-br from-yellow-50 to-amber-50 overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                    <div class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-yellow-400/20 to-amber-600/20 rounded-full -mr-16 -mt-16 group-hover:scale-150 transition-transform duration-500"></div>
                    <div class="relative p-6">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex-shrink-0 w-14 h-14 bg-gradient-to-br from-yellow-500 to-amber-600 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                                <svg class="h-7 w-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                                </svg>
                            </div>
                            <span class="text-xs font-semibold text-yellow-600 bg-yellow-100 px-3 py-1 rounded-full">Alert</span>
                        </div>
                        <h3 class="text-sm font-medium text-gray-600 mb-1">Damaged Assets</h3>
                        <p class="text-3xl font-bold text-gray-900">{{ $assetStats['damaged_assets'] }}</p>
                    </div>
                </div>

                <!-- Total Loss -->
                <div class="group relative bg-gradient-to-br from-red-50 to-rose-50 overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
                    <div class="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-red-400/20 to-rose-600/20 rounded-full -mr-16 -mt-16 group-hover:scale-150 transition-transform duration-500"></div>
                    <div class="relative p-6">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex-shrink-0 w-14 h-14 bg-gradient-to-br from-red-500 to-rose-600 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                                <svg class="h-7 w-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                            </div>
                            <span class="text-xs font-semibold text-red-600 bg-red-100 px-3 py-1 rounded-full">Loss</span>
                        </div>
                        <h3 class="text-sm font-medium text-gray-600 mb-1">Total Loss Value</h3>
                        <p class="text-3xl font-bold text-red-600">${{ number_format($assetStats['total_loss_value'], 2) }}</p>
                        <p class="text-xs text-gray-500 mt-1">Damaged: {{ $assetStats['damaged_assets'] }} | Lost: {{ $assetStats['lost_assets'] }}</p>
                    </div>
                </div>
            </div>
