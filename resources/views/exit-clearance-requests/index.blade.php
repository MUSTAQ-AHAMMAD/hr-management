<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-2xl rounded-2xl border border-gray-100 mb-4">
                <div class="p-4 border-b border-gray-200">
                    <form method="GET" action="{{ route('exit-clearance-requests.index') }}" class="flex flex-wrap gap-4 items-end">
                        ...
                        <div class="flex gap-2">
                            ...
                            <a href="{{ route('exit-clearance-requests.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-300 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200">
                                Clear
                            </a>
                            @endif
                        </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        {{ $request->exit_date?->format('M d, Y') }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex justify-end space-x-2">
                                            <a href="{{ route('exit-clearance-requests.show', $request) }}" class="text-navy-600 hover:text-navy-900">
                                            ...
                                            <a href="{{ route('exit-clearance-requests.edit', $request) }}" class="text-cobalt-600 hover:text-cobalt-900">
                                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <tr>
                                    <td colspan="7" class="px-6 py-4 text-center text-gray-500">
                                        No exit clearance requests found. <a href="{{ route('exit-clearance-requests.create') }}" class="text-navy-600 hover:text-navy-900">Create your first request</a>.
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
