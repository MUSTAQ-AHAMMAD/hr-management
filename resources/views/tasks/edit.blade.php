                    ...
                    <form action="{{ route('tasks.update', $task) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="type" name="type" type="text" class="mt-1 block w-full" :value="old('type', $task->type)" required placeholder="e.g., onboarding, exit, training" />
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="priority" name="priority" type="number" min="1" class="mt-1 block w-full" :value="old('priority', $task->priority)" required />
                        ...
                        <div class="mt-6">
                            ...
                            <textarea id="description" name="description" rows="4" class="mt-1 block w-full border-gray-300 focus:border-navy-500 focus:ring-navy-500 rounded-md shadow-sm">{{ old('description', $task->description) }}</textarea>
