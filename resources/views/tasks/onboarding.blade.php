<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <!-- Summary Card -->
            <div class="bg-white rounded-lg shadow-sm p-5 border-l-4 border-purple-500 mb-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-sm font-medium text-gray-500">Total Onboarding Tasks</p>
                                ...
                                <tr>
                                    <td colspan="5" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-gray-500 text-lg font-medium">No onboarding tasks found.</p>
                                        </div>
                                    </td>
                                </tr>
                                @endforelse
