                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <div class="flex justify-end space-x-2">
                                            <a href="{{ route('employees.show', $employee) }}" class="text-navy-600 hover:text-navy-900">
                                            ...
                                            @can('edit employees')
                                            <a href="{{ route('employees.edit', $employee) }}" class="text-cobalt-600 hover:text-cobalt-900">
                                                <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <tr>
                                    <td colspan="7" class="px-6 py-4 text-center text-gray-500">
                                        No employees found. <a href="{{ route('employees.create') }}" class="text-navy-600 hover:text-navy-900">Add your first employee</a>.
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
