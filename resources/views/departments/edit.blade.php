    ...
    <x-slot name="header">
        <div class="flex items-center">
            ...
            <h2 class="font-bold text-2xl text-gray-900 leading-tight">
                <span class="bg-gradient-to-r from-primary-600 to-cobalt-600 bg-clip-text text-transparent">Edit Department</span>
            </h2>
        </div>
    </x-slot>
                    ...
                    <form action="{{ route('departments.update', $department) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative mt-1">
                                    ...
                                    <x-text-input id="name" name="name" type="text" class="block w-full pl-10 pr-4 py-2.5 border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200" :value="old('name', $department->name)" required autofocus placeholder="Enter department name" />
                                </div>
                            ...
                            <div>
                                ...
                                <div class="relative mt-1">
                                    ...
                                    <x-text-input id="type" name="type" type="text" class="block w-full pl-10 pr-4 py-2.5 border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200" :value="old('type', $department->type)" required placeholder="e.g., IT, Admin, Finance, HR, Operations" />
                                </div>
                        ...
                        <div class="mt-6">
                            ...
                            <div class="relative mt-1">
                                ...
                                <textarea id="description" name="description" rows="4" placeholder="Describe the department's purpose and responsibilities..." class="mt-1 block w-full pl-10 pr-4 py-2.5 border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200">{{ old('description', $department->description) }}</textarea>
                            </div>
                        ...
                        <div class="mt-6">
                            <div class="bg-gradient-to-r from-gray-50 to-blue-50 border border-gray-200 rounded-lg p-4">
                                <label class="flex items-center cursor-pointer group">
                                    <input type="checkbox" name="is_active" value="1" class="rounded border-gray-300 text-primary-600 shadow-sm focus:ring-primary-500 transition-all duration-200" {{ old('is_active', $department->is_active) ? 'checked' : '' }}>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    @if($field->field_type === 'text')
                                        <x-text-input id="custom_field_{{ $field->id }}" name="custom_fields[{{ $field->id }}]" type="text" class="mt-1 block w-full py-2.5 border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200" :value="old('custom_fields.' . $field->id, $fieldValue)" :required="$field->is_required" />
                                    @elseif($field->field_type === 'textarea')
                                        <textarea id="custom_field_{{ $field->id }}" name="custom_fields[{{ $field->id }}]" rows="3" class="mt-1 block w-full py-2.5 border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200" {{ $field->is_required ? 'required' : '' }}>{{ old('custom_fields.' . $field->id, $fieldValue) }}</textarea>
                                    @elseif($field->field_type === 'number')
                                        <x-text-input id="custom_field_{{ $field->id }}" name="custom_fields[{{ $field->id }}]" type="number" class="mt-1 block w-full py-2.5 border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200" :value="old('custom_fields.' . $field->id, $fieldValue)" :required="$field->is_required" />
                                    @elseif($field->field_type === 'date')
                                        <x-text-input id="custom_field_{{ $field->id }}" name="custom_fields[{{ $field->id }}]" type="date" class="mt-1 block w-full py-2.5 border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200" :value="old('custom_fields.' . $field->id, $fieldValue)" :required="$field->is_required" />
                                    ...
                                    @elseif($field->field_type === 'checkbox')
                                        <label class="flex items-center mt-2">
                                            <input type="checkbox" name="custom_fields[{{ $field->id }}]" value="1" class="rounded border-gray-300 text-primary-600 shadow-sm focus:ring-primary-500 transition-all duration-200" {{ old('custom_fields.' . $field->id, $fieldValue) ? 'checked' : '' }}>
