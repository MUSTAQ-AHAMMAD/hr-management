...
<aside x-data="{ open: false }" class="w-64 gradient-navy text-white flex-shrink-0 hidden md:flex md:flex-col shadow-2xl">
    ...
    <div class="h-16 flex items-center justify-center border-b border-white/10">
        <a href="{{ route('dashboard') }}" class="flex items-center group">
            <div class="relative">
                ...
                <div class="absolute -top-1 -right-1 w-2 h-2 bg-primary-400 rounded-full"></div>
            </div>
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        ...
        <!-- Tasks with Submenu -->
        @can('view tasks')
        <div x-data="{ open: {{ request()->routeIs('tasks.*') || request()->routeIs('task-assignments.by-employee') || request()->routeIs('task-assignments.employee-detail') ? 'true' : 'false' }} }">
            <button @click="open = !open" class="group flex items-center justify-between w-full px-3 py-2.5 text-sm font-medium rounded-xl transition-all duration-200 {{ request()->routeIs('tasks.*') || request()->routeIs('task-assignments.by-employee') || request()->routeIs('task-assignments.employee-detail') ? 'bg-gradient-to-r from-primary-500 to-cobalt-600 text-white shadow-lg' : 'text-gray-300 hover:bg-white/10 hover:text-white' }}">
                <div class="flex items-center">
                    <svg class="h-5 w-5 mr-3 group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div x-show="mobileOpen" 
        ...
        <div class="w-64 gradient-navy text-white overflow-y-auto">
            <div class="p-4 space-y-1">
                <!-- Dashboard -->
                <a href="{{ route('dashboard') }}" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-xl {{ request()->routeIs('dashboard') ? 'bg-gradient-to-r from-primary-500 to-cobalt-600 text-white shadow-lg' : 'text-gray-300 hover:bg-white/10' }}">
                ...
                <!-- Employees -->
                @can('view employees')
                <a href="{{ route('employees.index') }}" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-xl {{ request()->routeIs('employees.*') ? 'bg-gradient-to-r from-primary-500 to-cobalt-600 text-white shadow-lg' : 'text-gray-300 hover:bg-white/10' }}">
                    <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
                    Employees
                ...
                <!-- Onboarding -->
                @can('view onboarding')
                <a href="{{ route('onboarding-requests.index') }}" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-xl {{ request()->routeIs('onboarding-requests.*') ? 'bg-gradient-to-r from-primary-500 to-cobalt-600 text-white shadow-lg' : 'text-gray-300 hover:bg-white/10' }}">
                    <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                    </svg>
                    Onboarding
                ...
                <!-- Exit Clearance -->
                @can('view exit-clearance')
                <a href="{{ route('exit-clearance-requests.index') }}" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-xl {{ request()->routeIs('exit-clearance-requests.*') ? 'bg-gradient-to-r from-primary-500 to-cobalt-600 text-white shadow-lg' : 'text-gray-300 hover:bg-white/10' }}">
                    <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                    </svg>
                    Exit Clearance
                ...
                <!-- Departments -->
                @can('view departments')
                <a href="{{ route('departments.index') }}" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-xl {{ request()->routeIs('departments.*') ? 'bg-gradient-to-r from-primary-500 to-cobalt-600 text-white shadow-lg' : 'text-gray-300 hover:bg-white/10' }}">
                    <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                    </svg>
                    Departments
                ...
                <!-- Users -->
                @can('view users')
                <a href="{{ route('users.index') }}" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-xl {{ request()->routeIs('users.*') ? 'bg-gradient-to-r from-primary-500 to-cobalt-600 text-white shadow-lg' : 'text-gray-300 hover:bg-white/10' }}">
                    <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
                    Users
                ...
                @can('view tasks')
                <div x-data="{ open: {{ request()->routeIs('tasks.*') || request()->routeIs('task-assignments.by-employee') || request()->routeIs('task-assignments.employee-detail') ? 'true' : 'false' }} }">
                    <button @click="open = !open" class="flex items-center justify-between w-full px-3 py-2.5 text-sm font-medium rounded-xl {{ request()->routeIs('tasks.*') || request()->routeIs('task-assignments.by-employee') || request()->routeIs('task-assignments.employee-detail') ? 'bg-gradient-to-r from-primary-500 to-cobalt-600 text-white shadow-lg' : 'text-gray-300 hover:bg-white/10' }}">
                        <div class="flex items-center">
                            <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                            </svg>
                ...
                <!-- Assets -->
                <a href="{{ route('assets.index') }}" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-xl {{ request()->routeIs('assets.*') ? 'bg-gradient-to-r from-primary-500 to-cobalt-600 text-white shadow-lg' : 'text-gray-300 hover:bg-white/10' }}">
                    <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z" />
                    </svg>
                    Assets
                ...
                <a href="{{ route('custom-fields.index') }}" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-xl {{ request()->routeIs('custom-fields.*') ? 'bg-gradient-to-r from-primary-500 to-cobalt-600 text-white shadow-lg' : 'text-gray-300 hover:bg-white/10' }}">
                    <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
