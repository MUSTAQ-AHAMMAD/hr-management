    ...
    <x-slot name="header">
        <div class="flex items-center">
            ...
            <h2 class="font-bold text-2xl text-gray-900 leading-tight">
                <span class="bg-gradient-to-r from-primary-600 to-cobalt-600 bg-clip-text text-transparent">Create Task</span>
            </h2>
        </div>
    </x-slot>
                    ...
                    <form action="{{ route('tasks.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative mt-1">
                                    ...
                                    <x-text-input id="name" name="name" type="text" class="block w-full pl-10 pr-4 py-2.5 border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200" :value="old('name')" required autofocus placeholder="Enter task name" />
                                </div>
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500">Select the type of task for proper categorization</p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                            ...
                            <div>
                                ...
                                <div class="relative mt-1">
                                    ...
                                    <x-text-input id="priority" name="priority" type="number" min="1" class="block w-full pl-10 pr-4 py-2.5 border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200" :value="old('priority', 1)" required />
                                </div>
                                <x-input-error class="mt-2" :messages="$errors->get('priority')" />
                                <p class="mt-1 text-xs text-gray-500">Lower numbers indicate higher priority (1 = highest)</p>
                            </div>
                        </div>
                        ...
                        <div class="mt-6">
                            ...
                            <div class="relative mt-1">
                                ...
                                <textarea id="description" name="description" rows="4" placeholder="Provide detailed instructions for completing this task..." class="mt-1 block w-full pl-10 pr-4 py-2.5 border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200">{{ old('description') }}</textarea>
                            </div>
                        ...
                        <div class="mt-6">
                            <div class="bg-gradient-to-r from-gray-50 to-blue-50 border border-gray-200 rounded-lg p-4">
                                <label class="flex items-center cursor-pointer group">
                                    <input type="checkbox" name="is_active" value="1" class="rounded border-gray-300 text-primary-600 shadow-sm focus:ring-primary-500 transition-all duration-200" @checked(old('is_active', true))>
